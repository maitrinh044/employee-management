...
public class AccountContentPanel extends javax.swing.JPanel {
    ...
    public void loadDataToTable(List<AccountDTO> accountList) {
        ...
        for (AccountDTO acc : accountList) {
            Object[] rowData = {
                ...
                acc.getEmployeeId(),
                acc.getUsername(),
                roleBUS.getRoleNameById(acc.getRoleId()),
                acc.isStatus() ? "Hoạt động" : "Không hoạt động"
            };
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Danh sách tài khoản", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 16))); // NOI18N
