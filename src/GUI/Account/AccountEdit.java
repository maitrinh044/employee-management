...
public class AccountEdit extends javax.swing.JFrame {
     ...
     */
    public AccountEdit(AccountDTO existAccount) {
        initComponents();
        System.out.println(existAccount);
        account = new AccountDTO(existAccount);
        emplBUS = new EmployeeBUS();
        accountBUS = new AccountBUS();
        roleBUS = new RoleBUS();
        if (existAccount != null) {
            cbbID.addItem(existAccount.getAccountId());
            
            txtName.setText(emplBUS.getById(existAccount.getAccountId()).getFullName());
            txtUsername.setText(existAccount.getUsername());
            txtPass1.setText(existAccount.getPassword());
            txtPass2.setText(existAccount.getPassword());
            cbbStatus.addItem(existAccount.isStatus() == true ? "Hoạt động" : "Không hoạt động");
            cbbRole.addItem(roleBUS.getRoleNameById(existAccount.getRoleId()));
