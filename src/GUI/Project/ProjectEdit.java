...
public class ProjectEdit extends javax.swing.JFrame {
    ...
    private ProjectDTO selectedPrj;
    
    /**
     * Creates new form ProjectEdit
     * @param prj
     */
    public ProjectEdit(ProjectDTO prj) {
        initComponents();
        selectedPrj = new ProjectDTO(prj);
        
        txtName.setText(selectedPrj.getProjectName());
        startDate.setDate(selectedPrj.getStartDate());
        endDate.setDate(selectedPrj.getEndDate());
        
        List<EmployeeDTO> emList = emplBUS.getAllEmployees();
        for (EmployeeDTO em : emList) {
            cbbMID.addItem(em.getEmployeeId());
        }
        cbbMID.setSelectedItem(selectedPrj.getManagerId());
        
        cbbStatus.addItem("Hoạt động");
        cbbStatus.addItem("Không hoạt động");
        cbbStatus.setSelectedItem(selectedPrj.getStatus() ? "Hoạt động" : "Không hoạt động");
    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        ProjectDTO project = new ProjectDTO(selectedPrj.getProjectId(), pName, start, end, mId, true);
        if (projectBUS.updateProject(project)) {
