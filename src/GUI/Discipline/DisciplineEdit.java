 ...
 * @author MaiTrinh
 */
public class DisciplineEdit extends javax.swing.JFrame {

    DisciplineBUS discBUS;
    EmployeeBUS emplBUS;
    DisciplineDTO selectedDisc;

    /**
     * Creates new form DisciplineEdit
     *
     * @param disc
     */
    public DisciplineEdit(DisciplineDTO disc) {
        initComponents();

        discBUS = new DisciplineBUS();
        emplBUS = new EmployeeBUS();
        selectedDisc = new DisciplineDTO(disc);
        
        cbbID.addItem(disc.getEmployeeId());
        EmployeeDTO empl = emplBUS.getById(disc.getEmployeeId());
        txtName.setText(empl.getFullName());
        txtAmount.setText(String.valueOf(disc.getDisciplineAmount()));
        txtDesc.setText(disc.getDescription());
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        selectedDisc.setDisciplineAmount(amount);
        selectedDisc.setDescription(desc);
        if (discBUS.update(selectedDisc)) {
