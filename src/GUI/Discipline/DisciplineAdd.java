 ...
 * @author MaiTrinh
 */
public class DisciplineAdd extends javax.swing.JFrame {
    DisciplineBUS discBUS;
    EmployeeBUS emplBUS;
    
    /**
     * Creates new form DisciplineAdd
     */
    public DisciplineAdd() {
        ...
        List<EmployeeDTO> emplList = emplBUS.getAllEmployees();
        for (EmployeeDTO em : emplList) {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (txtamount.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Không được để trống tiền ph", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        if (desc.isEmpty()) {
        ...
        if (!txtamount.matches("\\d+")) {
            JOptionPane.showMessageDialog(null, "Tiền phạt phải là số nguyên dương", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            return;
        } else {
        ...
        DisciplineDTO disc = new DisciplineDTO(-1, emplID, amount, desc, date, true);
        if (discBUS.addDiscipline(disc)) {
            JOptionPane.showMessageDialog(null, "Thêm kỷ luật thành công", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Thêm kỷ luật không thành công", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
        }
