 ...
 * @author MaiTrinh
 */
public class RewardAdd extends javax.swing.JFrame {

    private EmployeeBUS emplBUS;
    private RewardBUS rewardBUS;

    /**
     * Creates new form RewardAdd
     */
    public RewardAdd() {
        initComponents();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        RewardDTO rw = new RewardDTO(-1, emplID, date, amount, desc, true);
        if (rewardBUS.addReward(rw)) {
            JOptionPane.showMessageDialog(null, "Thêm khen thưởng thành công", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Thêm khen thưởng không thành công", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
        }
