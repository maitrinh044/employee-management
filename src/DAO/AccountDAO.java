...
public class AccountDAO {
    ...
    public boolean add(AccountDTO account) {
        String sql = "INSERT INTO accounts (employee_id, username, password, role_id, created_at, status) VALUES (?, ?, ?, ?, ?, true)";
    ...
    public boolean update(AccountDTO account) {
        String sql = "UPDATE accounts SET username = ?, password = ?, role_id = ? WHERE account_id = ?";
        try (Connection conn = dbConnect.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
    ...
    //
    public List<AccountDTO> searchByUsername(String keyword) {
